        ...
        document.getElementById("btn" + i.toString() + j.toString()).ondblclick = function() {
            if(checkgame===1){
                ...
                if (arr2[i][j] == 0) {
                    ...
                    var ii = 0;
                    var jj = 0;
                    if((hoa < dongcot * dongcot)){
                        while(arr2[ii][jj] != 0 ){
                            ii = randomso(0,arr2.length);
                            jj = randomso(0,arr2.length);
                        }
                        document.getElementById("btn" + (ii).toString() + (jj).toString()).style.color = "red";
                        document.getElementById("btn" + (ii).toString() + (jj).toString()).innerText = "O";
                        arr[ii][jj] = 2;
                        arr2[ii][jj] = 1;
                        hoa++;
                        checkWinner(dongcot);
